      ...
      <div className="_container">
        ...
        <div className="form">
          <div className="contact-info">
            ...
            <p className="text">Thanks for reaching out! We’ll get back to you soon. In the meantime, feel free to explore our latest articles or connect with us on social media. Happy reading!</p>
            <div className="info">
